...
function InstructorDashboard({ listOfCourses }) {
  ...
  function calculateTotalStudentsAndProfit() {
    ...
    const { totalProfit, studentList } = listOfCourses.reduce(
      (acc, course) => {
        const courseStudentCount = course.students.length;
        acc.totalProfit += course.pricing * courseStudentCount;
  
        course.students.forEach((student) => {
          // Track unique students using email (or use student._id if available)
          uniqueStudents.add(student.studentEmail);
